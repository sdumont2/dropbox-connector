    ...
    extends ActionExecuterAbstractBase
{
    ...
    protected void executeImpl(Action action, final NodeRef actionedUponNodeRef)
    {
        ...
        if (lockStatus.equals(LockStatus.NO_LOCK) || lockStatus.equals(LockStatus.LOCK_EXPIRED))
        {
            ...
            {
                syncedUsers = dropboxConnector.getSyncedUsers(actionedUponNodeRef);
            }
    ...
    private void updateParent(NodeRef nodeRef)
    {
        ...
        {
            Metadata metadata = dropboxConnector.getMetadata(parent);
            dropboxConnector.persistMetadata(metadata, parent);
        }
    }
